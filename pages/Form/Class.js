...
class Class extends Component {
    ...
    dbTblName = 'edu_class'
    requiredField = ["class"]
    allFiled = ["class", "class_sl"]
    dataSubmitLink = '/req/v5/call/class_entry'
    getDatalistLink = '/req/v5/classList'
    dataEditReqLink = '/req/v5/classEdit'
    dataEditLink = '/req/v5/info/update/edu_class'
                                        ...
                                        <div className="card">
                                            ...
                                            <div className="form-group row">
                                                    ...
                                                    <div className="col-md-7">
                                                        <input {...this.inputAttr('text', "form-control", "class_sl", "")} />
                                                    </div>
                                                </div>
                                                ...
                                                <div className="form-group row">
                                                    ...
                                                    <div className="col-md-7">
                                                        <input {...this.inputAttr('text', "form-control", "class", "")} />
                                                    </div>
                                                </div>
