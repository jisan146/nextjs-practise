...
class Department extends Component {
    ...
    page_id = '/Form/Department'
    dbTblName = 'department'
    requiredField = ["department"]
    allFiled = ['department']
    dataSubmitLink = '/req/v5/call/department_entry'
    getDatalistLink = '/req/v5/deptList'
    dataEditReqLink = '/req/v5/deptEdit'
    dataEditLink = '/req/v5/info/update/department'
                                            ...
                                            <div className="card-body">
                                                <div className="form-group row">
                                                    ...
                                                    <div className="col-md-7">
                                                        <input {...this.inputAttr('text', "form-control", "department", "")} />
                                                    </div>
                                                </div>
