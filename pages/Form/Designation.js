...
class Department extends Component {
    ...
    page_id = '/Form/Designation'
    dbTblName = 'designation'
    requiredField = ["designation", "department"]
    allFiled = ["designation", "department"]
    dataSubmitLink = '/req/v5/call/designation_entry'
    getDatalistLink = '/req/v5/designationList'
    dataEditReqLink = '/req/v5/designationListEdit'
    dataEditLink = '/req/v5/info/update/designation'
                                        ...
                                        <div className="card">
                                            ...
                                            <div className="card-body">
                                                ...
                                                <div className="form-group row">
                                                    ...
                                                    <div className="col-md-7">
                                                        <input {...this.inputAttr('text', "form-control", "designation", "")} />
                                                    </div>
                                                </div>
