...
class ApplicationPage extends Component {
    ...
    page_id = '/Form/ApplicationPage'
    dbTblName = 'application_menu_pages'
    requiredField = ["page", "link", "icon", 'menu']
    allFiled = ["page", "link", "icon", 'menu']
    dataSubmitLink = '/req/v5/NewData/application_menu_pages'
    getDatalistLink = '/req/v5/applicationPageList'
    dataEditReqLink = '/req/v5/applicationPageListEdit'
    dataEditLink = '/req/v5/info/update/application_menu_pages'
                                        ...
                                        <div className="card">
                                            ...
                                            <div className="card-body">
                                                ...
                                                <div className="form-group row">
                                                    <label className="col-md-3 col-form-label">Menu<span className="text-danger">*</span></label>
                                                    <div className="col-md-7">
                                                        <select {...this.selectInputAttr("form-control", "menu", "selectMenuList")}>
                                                            <option value={''}>-- Menu --</option>
                                                            {this.state.menu_SelectList}
                                                        </select>
                                                    </div>
                                                </div>

                                                <div className="form-group row">
                                                    <label className="col-md-3 col-form-label">Page<span className="text-danger">*</span></label>
                                                    <div className="col-md-7">
                                                        <input {...this.inputAttr('text', "form-control", "page", "")} />
                                                    </div>
                                                </div>

                                                <div className="form-group row">
                                                    <label className="col-md-3 col-form-label">Page Link<span className="text-danger">*</span></label>
                                                    <div className="col-md-7">
                                                        <input {...this.inputAttr('text', "form-control", "link", "")} />
                                                    </div>
                                                </div>

                                                <div className="form-group row">
                                                    <label className="col-md-3 col-form-label">Page Icon<span className="text-danger">*</span></label>
                                                    <div className="col-md-7">
                                                        <input {...this.inputAttr('text', "form-control", "icon", "")} />
                                                    </div>
                                                </div>
