...
class ApplicationMenu extends Component {
    ...
    host = ""
    pageTitle = 'Menu'
    page_id = '/Form/ApplicationMenu'
    dbTblName = 'application_menu'
    requiredField = ["menu", "left_icon"]
    allFiled = ["menu", "left_icon", "viewsl"]
    dataSubmitLink = '/req/v5/NewData/application_menu'
    getDatalistLink = '/req/v5/applicationMenuList'
    dataEditReqLink = '/req/v5/deptEdit'
    dataEditLink = '/req/v5/info/update/application_menu'
                                        ...
                                        <div className="card">
                                            ...
                                            <div className="card-body">
                                                ...
                                                <div className="form-group row">
                                                    <label className="col-md-3 col-form-label">Primary Menu<span className="text-danger">*</span></label>
                                                    <div className="col-md-7">
                                                        <input {...this.inputAttr('text', "form-control", "menu", "")} />
                                                    </div>
                                                </div>

                                                <div className="form-group row">
                                                    <label className="col-md-3 col-form-label">Left Icon<span className="text-danger">*</span></label>
                                                    <div className="col-md-7">
                                                        <input {...this.inputAttr('text', "form-control", "left_icon", "")} />
                                                    </div>
                                                </div>
                                                ...
                                                <div className="form-group row">
                                                    <label className="col-md-3 col-form-label">Menu SL<span className="text-danger"></span></label>
                                                    <div className="col-md-7">
                                                        <input {...this.inputAttr('text', "form-control", "viewsl", "")} />
                                                    </div>
                                                </div>
